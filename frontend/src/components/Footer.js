    ...
    <footer className="footer">
      <div className="grid-container">
        <div className="grid-item">
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <a href="https://www.instagram.com/voltix_solution/" target="_blank">
            <svg
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;
          <a
            href="https://www.facebook.com/voltixsoluti0n/?show_switched_toast=0&show_invite_to_follow=0&show_switched_tooltip=0&show_podcast_settings=0&show_community_review_changes=0&show_community_rollback=0&show_follower_visibility_disclosure=0"
            target="_blank"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;
          <a href="https://twitter.com/VoltixSolution" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;
          <a
            href="https://www.linkedin.com/company/voltix--solution/"
            target="_blank"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="grid-item">
          ...
          <p className="text-[#8D8D8E] mt-4">
            ...
            with us and explore how we can collaborate to achieve your goals.
          </p>
        </div>
      </div>
